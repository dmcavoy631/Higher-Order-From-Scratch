...
//////////////////////////////////////////
// Convert up array of strings to numbers
//////////////////////////////////////////

const stringsToNumbs = (numbers) =>{
  const arrayNum = []
  for(let x of numbers){
        arrayNum.push(parseInt(x));
      }
  return arrayNum;
}  

const arrayNums = stringsToNumbs(strNums);
...
// Even Odd Map
//////////////////////////////////////////
const evenOddMap = arrayNums.map(num => (num % 2 ? "Even" : "Odd"));


console.log(evenOddMap);
...
//////////////////////////////////////////
const total = (A, B) => A + B;
const arrayTotal = arrayNums.filter(even => even % 2 === 0).reduce(total);
